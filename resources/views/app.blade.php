...
<script data-localSrc="{{mix('js/app.js')}}" type="text/javascript"
    src="//cdn.jsdelivr.net/gh/Elu-Thingol/EluBlog@1.1.1/public/vendor/app/js/app.js" jspathanchor="true"
    onerror="errorload(this)"></script>

<script data-localSrc="{{mix('js/app-heart.js')}}" type="text/javascript"
    src="//cdn.jsdelivr.net/gh/Elu-Thingol/EluBlog@1.1.1/public/vendor/app/js/app-heart.js" onerror="errorload(this)">
</script>

<script data-localSrc="{{mix('js/app-other.js')}}" type="text/javascript"
    src="//cdn.jsdelivr.net/gh/Elu-Thingol/EluBlog@1.1.1/public/vendor/app/js/app-other.js" onerror="errorload(this)">
</script>

<script data-localSrc="{{mix('vendor/live2dw/lib/L2Dwidget.min.js')}}" type="text/javascript"
    src="//cdn.jsdelivr.net/gh/Elu-Thingol/EluBlog@1.1.1/public/vendor/live2dw/lib/L2Dwidget.min.js"
    onerror="errorload(this)"></script>

<script data-localSrc="{{mix('vendor/live2dw/lib/L2Dwidget.0.min.js')}}" type="text/javascript"
    src="//cdn.jsdelivr.net/gh/Elu-Thingol/EluBlog@1.1.1/public/vendor/live2dw/lib/L2Dwidget.0.min.js"
    onerror="errorload(this)">
</script>
